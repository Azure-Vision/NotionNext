...
export default function HeaderArticle({ post, siteInfo }) {
  ...
  return (
    ...
    >
      <header className="animate__slideInDown animate__animated absolute top-0 w-full h-96 py-10 flex justify-center items-center font-sans"> // bg-black bg-opacity-70 
        <div className='mt-24'>
          {/* 文章Title */}
          ...
          <section className="flex-wrap shadow-text flex text-sm justify-center mt-2 text-white dark:text-gray-400 font-light leading-8">
            ...
            👁️ <span className="mr-2 busuanzi_value_page_pv" />
            </div>}
          </section>
        </div>
      </header>
